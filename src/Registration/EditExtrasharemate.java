 ...
 * @author saddamnvn
 */
public class EditExtrasharemate extends JFrame {
    ...
    public EditExtrasharemate(String role,String prn) throws ParseException, JSONException
    {
        this.role=role;
        this.prn=prn;
        ...
        {// JSONArray sharemateeamount = new JSONArray();
          ...
          addflat.addActionListener(e->{
            try {
                ...
                Logger.getLogger(EditExtrasharemate.class.getName()).log(Level.SEVERE, null, ex);
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(EditExtrasharemate.class.getName()).log(Level.SEVERE, null, ex);
            } catch (SQLException ex) {
                Logger.getLogger(EditExtrasharemate.class.getName()).log(Level.SEVERE, null, ex);
             ...
             for(int i=0;i<prelength;i++)
            {
             ...
             else
             {
                ...
                flatinfo=connection.getsharemateprojectflatinfo(prn);
                 ...
                 for(int i=0;i<prelength;i++)
                 {
                  connection.Editsharemateinfodata(prn,Integer.toString(prelength),fltname[i].getText(),fltdebit[i].getText(),flatinfo,datedata[i],i);
    ...
    addflatinformation();
     ...
     EditExtrasharemate window = new  EditExtrasharemate("","");
